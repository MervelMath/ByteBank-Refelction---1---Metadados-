    ...
    public class ActionBinder
    {
        public ActionBindInfo ObterActionBindInfo(object controller, string path)
        {
            ...
            else
            {
                ...
                var methodInfo = ObterMethodInfoAPartirDeNomeArgumentos(nomeAction, nomeArgumentos, controller);
        ...
        private MethodInfo ObterMethodInfoAPartirDeNomeArgumentos(string nomeAction, string[] argumentos, object controller)
        {
